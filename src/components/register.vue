    ...
    <el-row style="padding:100px">
      ...
      >
        ...
        <el-form ref="form" label-width="80px" style="width:80%;padding:20px;">
          ...
          <el-form-item label="密码">
            <el-input placeholder="请再次输入您的密码" v-model="pwd1" type="password"></el-input>
          </el-form-item>
        </el-form>

        <el-button type="primary" round style="width:200px;background-color:#B3C0F7;border:none" @click="register">注册</el-button>
      </el-col>
       <!-- <el-col>{{data}}</el-col> -->
    </el-row>
  </el-row>
...
export default {
  ...
  methods: {
    register() {
      //   alert(this.name + ":" + this.pwd + ":" + this.pwd1);
